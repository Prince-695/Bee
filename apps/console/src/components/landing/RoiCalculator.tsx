...
export function RoiCalculator() {
  ...
  // Estimates: Bee saves ~8 hours per engineer/week (debugging, code review, test repairs, PR inspections)
  ...
  const beeCostAnnual = engineers * 39 * 12; // Pro tier yearly rate
